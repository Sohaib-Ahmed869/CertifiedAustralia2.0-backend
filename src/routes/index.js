...
const marketingSourceRoutes = require('./marketingSourceRoutes');
const adCampaignRoutes = require('./adCampaignRoutes');
...
router.use('/marketing-sources', marketingSourceRoutes);
router.use('/ad-campaigns', adCampaignRoutes);
